...
class SPlotRK : public TNamed {

 public:

  SPlotRK();
  SPlotRK(const SPlotRK &other);
  SPlotRK(const char* name, const char* title);
  SPlotRK(const char* name, const char* title, const RooDataSet &data);
  SPlotRK(const char* name, const char* title,RooDataSet& data, RooAbsPdf* pdf,
 ...
 protected:
  ...
  ClassDef(SPlotRK,1)   // Class used for making sPlots
