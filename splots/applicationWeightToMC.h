...
// Tue Jun 21 16:06:22 2022 by ROOT version 6.24/06
// from TTree mytreefit/mytreefit
// found on file: forMeas_xgbmodel_kee_12B_kee_correct_pu_Depth17_LowPtPF_v7.3_nonreg_ALL_MCres.root
//////////////////////////////////////////////////////////

#ifndef applicationWeightToMC_h
#define applicationWeightToMC_h
...
class applicationWeightToMC {
 public :
  ...
  applicationWeightToMC(TTree *tree=0);
  virtual ~applicationWeightToMC();
...
#ifdef applicationWeightToMC_cxx
applicationWeightToMC::applicationWeightToMC(TTree *tree) : fChain(0) 
{
...
applicationWeightToMC::~applicationWeightToMC()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t applicationWeightToMC::GetEntry(Long64_t entry)
{
...
Long64_t applicationWeightToMC::LoadTree(Long64_t entry)
{
...
Bool_t applicationWeightToMC::Notify()
{
...
void applicationWeightToMC::Show(Long64_t entry)
{
...
Int_t applicationWeightToMC::Cut(Long64_t entry)
{
...
#endif // #ifdef applicationWeightToMC_cxx
