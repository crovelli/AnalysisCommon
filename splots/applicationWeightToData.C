...
void applicationWeightToData::Loop(int theVariable)       // theVariable must be coherent with .h : 0=ele1pt, 1=ele2pt, 2=elesDr
{
  ...
  leg2.Draw();
  if (theVariable==0) c2d.SaveAs("Bmass_withAndWoEle1PtWeight.png");
  if (theVariable==1) c2d.SaveAs("Bmass_withAndWoEle2PtWeight.png");
  if (theVariable==2) c2d.SaveAs("Bmass_withAndWoElesDrWeight.png");
}
